...
@Injectable()
export class JiraFeatureServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAll(skipCount: number, maxResultCount: number): Observable<PagedResultDtoOfJiraFeatureDto> {
        let url_ = this.baseUrl + "/api/services/app/JiraFeature/GetAll?";
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfJiraFeatureDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfJiraFeatureDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfJiraFeatureDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfJiraFeatureDto.fromJS(resultData200) : new PagedResultDtoOfJiraFeatureDto();
            return Observable.of(result200);
            });
        } else if (status === 401) {
            return blobToText(responseBlob).flatMap(_responseText => {
        ...
        return Observable.of<PagedResultDtoOfJiraFeatureDto>(<any>null);
    }

}

export class JiraFeatureDto implements IJiraFeatureDto {
    key: string;
    issueType: string;
    priority: string;
    status: string;
    ...
    lastViewTime: moment.Moment | undefined;
    creationTime: moment.Moment | undefined;
    // roleNames: string[] | undefined;
    id: number | undefined;

    constructor(data?: JiraFeatureDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.subTasks = data["fields"].subTasks.length;
            this.summary = data["fields"].summary;
            //this.lastViewTime = data["lastViewed"] ? moment(data["lastViewed"].toString()) : <any>undefined;
            //this.creationTime = data["created"] ? moment(data["created"].toString()) : <any>undefined;
          /*  if (data["roleNames"] && data["roleNames"].constructor === Array) {
                this.roleNames = [];
                for (let item of data["roleNames"])
                    this.roleNames.push(item);
    ...
    static fromJS(data: any): JiraFeatureDto {
        data = typeof data === 'object' ? data : {};
        let result = new JiraFeatureDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["lastViewed"] = this.lastViewTime ? this.lastViewTime.toISOString() : <any>undefined;
        data["created"] = this.creationTime ? this.creationTime.toISOString() : <any>undefined;
       /* if (this.roleNames && this.roleNames.constructor === Array) {
            data["roleNames"] = [];
            for (let item of this.roleNames)
                data["roleNames"].push(item);
...
export interface IJiraFeatureDto {
    key: string;
    issueType: string;
    priority: string;
    status: string;
...
export class PagedResultDtoOfJiraFeatureDto implements IPagedResultDtoOfJiraFeatureDto {
    totalCount: number | undefined;
    items: JiraFeatureDto[] | undefined;
    constructor(data?: IPagedResultDtoOfJiraFeatureDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            ...
            if (data["issues"] && data["issues"].constructor === Array) {
                ...
                for (let item of data["issues"])
                    this.items.push(JiraFeatureDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfJiraFeatureDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfJiraFeatureDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfJiraFeatureDto {
    totalCount: number | undefined;
    items: JiraFeatureDto[] | undefined;
}
